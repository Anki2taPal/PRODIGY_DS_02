...
#Age
ggplot()+geom_point(data=ndata,aes(x=1:nrow(ndata),y=Age),shape=20)+labs(title="Age",x="Index",y="Values")
#Fare
ggplot()+geom_point(data=ndata,aes(x=1:nrow(ndata),y=Fare),shape=20)+labs(title="Fare",x="Index",y="Values")
#Parch
ggplot()+geom_point(data=ndata,aes(x=1:nrow(ndata),y=Parch),shape=20)+labs(title="Parch",x="Index",y="Values")
